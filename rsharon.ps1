...
IT IS STILL UNDER DEVELOPMENT, SOME FEATURES ARE UNDERWAY

PLEASE ONLY OPEN THIS FILE WITH POWERSHELL ISE AS POWERSHELL/CMD DO NOT SUPPORT DISPLAYING HEBREW WITH ACTIVE DIRECTORY QUERIES
#>
